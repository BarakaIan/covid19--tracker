...
public class All implements Serializable {
     ...
     */
    public
    All(Integer confirmed, Integer recovered, Integer deaths, String country, Integer population, Integer sqKmArea, String lifeExpectancy, String elevationInMeters, String continent, String abbreviation, String location, Integer iso, String capitalCity, String lat, String _long, String updated)
    {
        super();
